#!/bin/sh
# Exported PID / PROMPT_COUNTER / REPLACE_TEMP_FILE / TEMP_FOLDER
# from the caller do not reach the script.
...
printf 'REPLACE_TEMP_FILE=%s\n' "${REPLACE_TEMP_FILE-unset}"
...
export REPLACE_TEMP_FILE=/from-caller
...
expect_stdout_has 'REPLACE_TEMP_FILE=unset'
